...
const Home = () => {
  ...
  return (
    <div className="relative">
      ...
      <section className="absolute bottom-5 right-5 z-40 flex flex-col justify-end items-end gap-2 text-white">
        {isBotRealease && (
          <div className=" rounded-md w-[20rem]  md:w-[25rem] lg:w-[25rem] h-[70vh] bg-slate-900">
            ...
            <div className="h-[76%]  flex flex-col overflow-y-auto  gap-5 px-5 py-2 scroll-container">
              <div className="  self-start pb-5 w-auto">
                <div className="justify-end self-end px-5 py2  rounded-md bg-slate-800 w-auto">
                  <p>hi, Gaurav Patil</p>
            ...
            <div className="h-[12%] border-t">
              <input
                className="w-full h-full outline-none bg-slate-900 text-white px-4"
        ...
        <div className="relative w-[10rem] cursor-pointer group">
          ...
          >
            <MessageCircle
              size={30}
              className="fill-[#cdf0ed] -rotate-90
            stroke-none group-hover:fill-[#82e8f3]"
            />
